...
[![](https://img.shields.io/github/v/release/abmarvi/3x-ui.svg)](https://github.com/abmarvi/3x-ui/releases)
[![](https://img.shields.io/github/actions/workflow/status/abmarvi/3x-ui/release.yml.svg)](#)
[![GO Version](https://img.shields.io/github/go-mod/go-version/abmarvi/3x-ui.svg)](#)
[![Downloads](https://img.shields.io/github/downloads/abmarvi/3x-ui/total.svg)](#)
...
<p align="left">
  <a href="https://buymeacoffee.com/abmarvi" target="_blank">
...
```
bash <(curl -Ls https://raw.githubusercontent.com/abmarvi/3x-ui/master/install.sh)
```
...
```
VERSION=v1.7.9 && bash <(curl -Ls "https://raw.githubusercontent.com/abmarvi/3x-ui/$VERSION/install.sh") $VERSION
```
...
wget https://github.com/abmarvi/3x-ui/releases/latest/download/x-ui-linux-${XUI_ARCH}.tar.gz
```
...
2. **Clone the Project Repository:**
   ...
   ```sh
   git clone https://github.com/abmarvi/3x-ui.git
   cd 3x-ui
   ```
...
[![Stargazers over time](https://starchart.cc/abmarvi/3x-ui.svg)](https://starchart.cc/abmarvi/3x-ui)
